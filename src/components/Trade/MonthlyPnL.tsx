...
export default function MonthlyPnL() {
  const getCurrentMonthPnL = useTradeStore(state => state.getCurrentMonthPnL)
  const monthlyData = getCurrentMonthPnL()
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className={`col-span-2 p-6 rounded-lg ${isProfitable ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 mb-2">Total P&L</p>
        ...
        <div className="col-span-2 p-4 bg-gray-50 border border-gray-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div className="text-center">
                <p className="text-sm font-medium text-gray-600 mb-1">Winning Trades</p>
                <p className="text-xl font-bold text-green-600">{monthlyData.profitableTrades}</p>
              </div>
              <div className="h-8 w-px bg-gray-300"></div>
              <div className="text-center">
                <p className="text-sm font-medium text-gray-600 mb-1">Losing Trades</p>
      ...
      {monthlyData.totalTrades === 0 && (
        <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex items-center">
            ...
            <p className="text-yellow-800">No trades recorded for this month yet.</p>
          </div>
        </div>
      )}
    </div>
